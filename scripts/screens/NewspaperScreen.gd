...
func _ready() -> void:
	...
	var body := _label(String(article.body), 22, TEXT)
	...
	if meteor != "":
		...
		var line := _label(meteor, 22, TEXT)
	...
	cont.custom_minimum_size = Vector2(300, 48)
